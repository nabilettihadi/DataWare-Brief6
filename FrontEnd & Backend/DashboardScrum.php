                ...
                ?>
                            <tbody class="table-light ">
                                <tr>
                                    ...
                                    <td><a href="Modifier_Equipe.php?id=<?=$row['id_equipe']?>" class="ms-4"><i
                                                class="bi bi-pencil"></i></a></th>
                                    <td><a href="Supprimer_Equipe.php?id=<?=$row['id_equipe']?>"
